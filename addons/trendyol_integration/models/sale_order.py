...
class SaleOrder(models.Model):
    ...
    is_trendyol_order = fields.Boolean(string='Trendyol Siparişi mi?', compute='_compute_is_trendyol')
    ...
    trendyol_store_name = fields.Char(string='TY Mağaza Adı', related='trendyol_store_id.name', store=True, readonly=True)
    trendyol_seller_id = fields.Char(string='TY Seller ID', related='trendyol_store_id.seller_id', store=True, readonly=True)
