{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'ugurlar_barcode/static/src/js/camera_scanner.js',
            ...
            'ugurlar_barcode/static/src/css/sales_discount.css',
            'ugurlar_barcode/static/src/css/inventory_matrix.css',
            'ugurlar_barcode/static/src/js/screens/label_designer.js',
            'ugurlar_barcode/static/src/js/screens/cargo_label_designer.js',
            'ugurlar_barcode/static/src/js/screens/sales_discount.js',
            'ugurlar_barcode/static/src/js/screens/inventory_matrix.js',
