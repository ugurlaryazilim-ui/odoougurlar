{
    ...
    'depends': ['base_setup', 'product', 'mail', 'gamification', 'ugurlar_images', 'ugurlar_barcode'],
    'data': [
        ...
        'views/ai_studio_session_reports_views.xml',
        'views/ai_studio_dashboard_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'ugurlar_ai_studio/static/src/js/screens/dashboard_screen.js',
            ...
            'ugurlar_ai_studio/static/src/xml/dashboard_screen.xml',
